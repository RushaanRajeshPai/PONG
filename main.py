...
background = cv.imread('Pong\Resources\Background.png')
ball = cv.imread('Pong\Resources\Ball.png', cv.IMREAD_UNCHANGED)
bat1 = cv.imread('Pong\Resources\Bat1.png', cv.IMREAD_UNCHANGED)
bat2 = cv.imread('Pong\Resources\Bat2.png', cv.IMREAD_UNCHANGED)
